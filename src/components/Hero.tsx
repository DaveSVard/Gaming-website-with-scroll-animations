...
const Hero = () => {
  ...
  const upcomingVideoIndex = (currentIdx % totalVideos) + 1;

  const handleMiniVdClick = () => {
    setHasClicked(true);

    setCurrentIdx(upcomingVideoIndex);
  };
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      {isLoading && (
        <div className="flex-center absoluite z-100 h-dvh w-screen overflow-hidden bg-violet-50">
